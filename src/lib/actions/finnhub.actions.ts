    ...
    if (!trimmed) {
      ...
      results = profiles
        .map(({ sym, profile }) => {
          ...
          const name: string | undefined = (profile?.name as string) || (profile?.ticker as string) || undefined;
          const exchange: string | undefined = (profile?.exchange as string) || undefined;
